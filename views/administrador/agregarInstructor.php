...
?>
  ...
  <body>
    ...
    <br />
        <form action="../administrador/includes/agregarInstructor.php" method="POST" class="form1">
            <h2>Agregar Instructor <i class="fas fa-user-plus"></i></h2> <br />
            ...
            <input type="text" name="programa" id="programa" placeholder="Programa" required  /> <br /><br />
