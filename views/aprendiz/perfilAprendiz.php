...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/perfilAprendiz.css" />
    ...
    <body>
        ...
        <div>
            ...
            <h2>Aprendiz <br /><?php echo $fila['nombre'] ?> <?php echo $fila['apellidos'] ?></h2>
            <br /><br />
        <section class="form_wrap">
            ...
            <form action="includes/actualizarPerfil.php" method="POST" class="form_contact" onsubmit="return validar();">
                ...
                <div class="user_info">
                    ...
                    <input type="text" name="txtnombre" id="id" value="<?php echo $fila['id'] ?>" disabled/> 
                    ...
                    <br />
                    <input type="submit" value="Actualizar" id="#btnClose" />
                </div>
            </form>
        </section>
        <?php } ?>
